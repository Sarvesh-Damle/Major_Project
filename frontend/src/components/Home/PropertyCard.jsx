...
const PropertyCard = ({ card }) => {
  ...
  return (
    <>
      <div
        className='flexColStart gap-2 p-4 rounded-xl max-w-max m-auto transition-all duration-300 ease-in hover:scale-105 hover:cursor-pointer hover:bg-gradient-to-b from-[#ffffff] to-[#eeeef7] shadow hover:shadow-lg relative z-0 r-card'
      ...
      >
        ...
        {card.hostel_name && (
          <span className='primaryText max-sm:text-2xl'>{card.hostel_name}</span>
        )}
