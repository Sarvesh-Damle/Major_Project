      ...
      <div className='flex flex-wrap gap-y-8 p-6 innerWidth justify-around items-end max-lg:pt-12 hero-container'>
        ...
        <div className='flex flex-col justify-center items-start gap-12 hero-left'>
          <div className='relative z-[1] hero-title'>
            ...
            <motion.h1
              ...
              className='font-semibold text-6xl max-md:text-[2.5rem] max-md:leading-10 max-lg:text-5xl max-lg:leading-[3rem] leading-[4rem]'
            >
          ...
          <div className='flex flex-col justify-center gap-8 items-start text-xl text-gray-300 hero-des'>
            <span>
              <span className='text-orange-300 text-xl'>
                <ReactTyped
                  startWhenVisible
                  strings={['Need a PG?', 'Need a Hostel?', 'Need a Flat?']}
                  typeSpeed={60}
                  backSpeed={60}
                  loop
                />
            ...
            <span>Find one near your college/company/business!</span>
          </div>
        ...
        <div className='flex justify-center items-center flex-wrap gap-y-8 hero-right'>
          <motion.div
            ...
            transition={{ duration: 2, type: 'spring' }}
            className='w-[30rem] h-[35rem] overflow-hidden rounded-t-full border-8 border-solid border-white border-opacity-10 max-lg:w-[95%] max-lg:h-[30rem] max-md:w-[95%] max-md:h-[25rem] image-container'
          >
            <img
