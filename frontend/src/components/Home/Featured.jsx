...
const Featured = () => {
  ...
  return (
    <>
      {
        <div>
          <h1 className='flex justify-center items-center text-3xl p-1 my-2'>
            Featured Properties
          </h1>
          <section className='pt-5 lg:pt-8 pb-5 lg:pb-8 h-full bg-[#F3F4F6]'>
            <div className='container grid sm:grid-cols-2 lg:grid-cols-3 gap-12 my-3'>
              <SingleCard
                image='https://res.cloudinary.com/sarvesh-damle/image/upload/v1699075314/Buddies_MajorProject/city_images/wadala_image_wvpuys.jpg'
                CardTitle='Wadala'
                btnHref='/'
              ...
              />
              <SingleCard
                image='https://res.cloudinary.com/sarvesh-damle/image/upload/v1699075314/Buddies_MajorProject/city_images/dadar_image_eiedvw.jpg'
                CardTitle='Dadar'
                btnHref='/'
              ...
              />
              <SingleCard
                image='https://res.cloudinary.com/sarvesh-damle/image/upload/v1699075314/Buddies_MajorProject/city_images/nerul_image_eertt0.jpg'
                CardTitle='Nerul'
                btnHref='/'
    ...
    <>
      ...
      >
        ...
        <div className='p-8 text-center sm:p-9 md:p-7 xl:p-9'>
          ...
          <p className='text-base leading-relaxed mb-3 text-body-color'>{CardDescription}</p>
