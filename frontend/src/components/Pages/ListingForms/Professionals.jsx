...
const Professionals = () => {
  ...
  return (
    <>
      <div className='flex justify-center items-center font-medium text-xl mt-4'>Listing Property - For Professionals</div>
        ...
        <div className='flex flex-col sm:w-1/3 w-full'>
          ...
          <form onSubmit={handleSubmit(login)} className='mt-4'>
            <div className='space-y-5 m-4 p-5 shadow-md rounded-lg'>
              ...
              {companyCloser ? (
                <Input
                  label='Property Distance from company in minutes'
                  type='number'
                />
              ) : null}
              <Input
