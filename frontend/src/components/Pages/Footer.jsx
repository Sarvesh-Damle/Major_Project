const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20 innerWidth">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base mb-7 text-body-color">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit sint nulla placeat architecto expedita repellat!
                </p>
            ...
            <LinkGroup header="Company">
              <NavLink link="/about" label="About Buddies" />
              <NavLink link="/contact" label="Contact & Support" />
              <NavLink link="/#" label="Success History" />
              <NavLink link="/#" label="Settings & Privacy" />
            </LinkGroup>
