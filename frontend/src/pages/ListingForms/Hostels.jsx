    ...
    <>
          ...
          render={({ field }) => (
            <>
              <MultiSelect
                ...
                onBlur={field.onBlur}
                title='Select types of Rooms Provided'
                data={room_types}
                onSelect={(value) => setValue('room_type', value)}
              />
      ...
      <div className='mb-6'>
        <Controller
          ...
          render={({ field }) => (
            <>
              <label htmlFor='distance_from_bus_stop'>
                Distance from nearest Bus stop: (in meters)
              </label>
              <input
                {...field}
                type='number'
        ...
        <Controller
          ...
          render={({ field }) => (
            <>
              ...
              <div className='w-full my-2 overflow-auto flex gap-x-8'>
...
export const DropdownSelectOptions = ({
  name,
  options,
  title,
  dropdownTitle,
