          ...
          <div className='w-full flex justify-center px-4 lg:w-1/2 xl:w-6/12'>
            <div className='mb-12 max-w-[570px] lg:mb-0'>
              ...
              <p className='text-base leading-relaxed mb-9 text-body-color'>
                For rental inquiries or to learn more about our properties, please reach out to us
                using the contact information below. We look forward to assisting you in finding
                your ideal rental space.
              </p>
              <div className='mb-8 flex w-full max-w-[370px]'>
                ...
                <div className='w-full'>
                  ...
                  <p className='text-base text-body-color'>Wadala, Mumbai - 400037</p>
                </div>
              </div>
              <div className='mb-8 flex w-full max-w-[370px]'>
                <div className='mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-white sm:h-[70px] sm:max-w-[70px]'>
                ...
                <div className='w-full'>
                  ...
                  <p className='text-base text-body-color'>(+91) 93702 68697</p>
                </div>
              </div>
              <div className='mb-8 flex w-full max-w-[370px]'>
                <div className='mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-white sm:h-[70px] sm:max-w-[70px]'>
                ...
                <div className='w-full'>
                  ...
                  <p className='text-base text-body-color'>buddies@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
