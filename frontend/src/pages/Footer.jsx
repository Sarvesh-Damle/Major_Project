const Footer = () => {
  return (
    <>
      <footer className='relative z-10 bg-gray-50 pt-20 pb-4 lg:pt-[120px] w-full'>
        <div className='flex flex-wrap -mx-4'>
          <div className='w-full px-4 sm:w-2/3 lg:w-3/12'>
            <div className='w-full mb-4 flex flex-col ml-8'>
              <a href='/' className='mb-6 max-w-[160px]'>
                <img
              ...
              <p className='text-base'>
                Our rental real estate app helps you find the perfect accommodation!
              </p>
            </div>
          </div>
          ...
          <div className='w-full px-4 sm:w-1/2 lg:w-3/12'>
            <div className='w-full mb-10 flex flex-col justify-center items-center'>
              ...
              <p className='text-base text-body-color'> © {new Date().getFullYear()} Buddies</p>
            </div>
          </div>
        </div>
      </footer>
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`flex justify-center items-center mb-2 text-base leading-loose text-body-color hover:text-primary`}
        >
          {label}
        </a>
      </li>
