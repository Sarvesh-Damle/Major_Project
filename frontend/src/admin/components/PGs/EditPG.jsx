  ...
  return (
    <div className='bg-white w-screen overflow-hidden shadow rounded-lg border'>
      <div className='px-4 py-5 sm:px-6'>
        <h3 className='text-lg leading-6 font-medium text-gray-900'>PG Property Details</h3>
      </div>
      <div className='border-t border-gray-200 px-4 py-5 sm:p-0'>
        <dl className='sm:divide-y sm:divide-gray-200'>
          ...
          <div className='py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
            <dt className='text-sm font-medium text-gray-500'>PG Name</dt>
            <dd className='mt-1 text-sm font-medium text-gray-700 sm:mt-0 sm:col-span-2 capitalize'>
              <input type='text' value={pgName} onChange={(e) => setPgName(e.target.value)} />
            </dd>
          </div>
          <div className='py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
            <dt className='text-sm font-medium text-gray-500'>Preferred Tennants</dt>
          ...
          <div className='py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6'>
            <dt className='text-sm font-medium text-gray-500'>Food Included</dt>
            <dd className='mt-1 text-sm font-medium text-gray-700 sm:mt-0 sm:col-span-2 flex gap-x-6'>
              <div className='flex gap-x-2'>
                ...
                <input
                  ...
                  onClick={(e) => (e.target.value === 'Yes' ? setFoodIncluded(true) : null)}
                />
              </div>
              <div className='flex gap-x-2'>
                ...
                <input
                  ...
                  onClick={(e) => (e.target.value === 'No' ? setFoodIncluded(false) : null)}
                />
              </div>
            </dd>
          </div>
